...
- **Speed Ramp**: Variable speed control (M150) - FUNCTIONAL: linear ramp from 1x to target speed, source time integrated correctly (M180; was quadratic overshoot). Video ramp; audio keeps the clip's base speed
  - Access: Select clip > Inspector
...
- **Export Presets**: Platform-sized frames in exact export (M145, wired up in M181)
  - Access: Export dialog > Export size
  - Features: YouTube 1920x1080, TikTok 1080x1920, Instagram 1080x1080; the frame is scaled to fit and letterboxed black when the aspect differs. The realtime fallback records at preview size and says so in a toast.
...
*Last updated: M180 (speed ramp math fix) - September 26, 2026*
